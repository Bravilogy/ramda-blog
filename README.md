...
![Ramda version](ramda-version.png)
...
![episode 1: spread](episode-1.png)
...
![episode 2: reject and transform](episode-2.png)
...
![episode 3: format user](episode-3.png)
...
our code execution and throw loads of errors on the way. But we can defend ourselves with a few, beautiful monadic interfaces in the next
chapter and keep composing the life.
